...
import { loginModal } from '../../actions/actions';
  ...
  return (
    <C.Container>
      <header>
        ...
        {currentUser && (
          <div>
          <svg onClick={handleModalDelet} width="19" height="24" viewBox="0 0 19 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg onClick={handleModalEdit} width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
